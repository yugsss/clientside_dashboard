...
import { Plus, Upload, ExternalLink, AlertTriangle, CheckCircle } from 'lucide-react'
      ...
      <DialogContent className="bg-slate-800 border-slate-700 max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="googleDriveLink" className="text-slate-300">Google Drive Link *</Label>
              <Input
                id="googleDriveLink"
              ...
              <p className="text-slate-400 text-sm mt-1">
                Share your Google Drive folder containing raw video files. Make sure it's accessible to anyone with the link.
              </p>
            </div>

            <div>
              <Label htmlFor="requirements" className="text-slate-300">Special Requirements</Label>
              <Textarea
                id="requirements"
          ...
          {hasActiveProject && (
            <Alert className="border-yellow-500/50 bg-yellow-500/10">
              ...
              <AlertDescription className="text-yellow-200">
                You can only have one active project at a time based on your current plan. Please complete or approve your current project before creating a new one.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="flex justify-end space-x-3">
            ...
            <Button 
              type="submit" 
              disabled={loading || hasActiveProject}
